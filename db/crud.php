<?php
    class crud{
        ...
        public function insertAttendees($fname, $lname, $dob, $email,$contact,$specialty){
           try{
               $sql = "INSERT INTO attendee (firstname,lastname,dateofbirth,emailadd,phone,specialty_id) VALUES (:fname, :lname, :dob, :email,:contact,:specialty)";
        ...
        public function editAttendee($id,$fname, $lname, $dob, $email,$contact,$specialty){
           ...
           :dob,`emailadd`=:email,`phone`=:contact,`specialty_id`=:specialty WHERE attendee_id = :id";  
